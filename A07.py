...
#   S. Taushanoff 6/2/2025, Completed Assignment
# ------------------------------------------------------------------------------------------ #
import json
...
#Student class inherits from Person class and adds information about enrollment
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str):
        ...
        try:
            ...
            for individual in json_students:
